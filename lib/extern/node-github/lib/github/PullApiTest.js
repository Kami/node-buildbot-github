...
var test = module.exports = {
    ...
    "test: list pull request discussions" : function(finished) {
        test.pullApi.getDiscussion(username, repo, number, function(err, pull) {
            assert.ok(pull.discussion.length > 0);
            finished();
        });
    }
};
