...
(function() {
     ...
     */
    this.addComment = function(username, repo, issueNumber, commentBody, callback)
    {
        this.$api.post('issues/comment/' + encodeURI(username) + '/' + encodeURI(repo) + '/' + encodeURI(issueNumber), {
            'comment': commentBody
            },
            null,
